...
//        arrayList1.add(new DataModel("Title Event 1", 5000000, "02 August 2023", R.drawable.jalihara_logo, "10:00 PM", "Jakarta, Indonesia", "Deskripsi Event"));
        ...
        arrayTicketOdd.add(new DataModel("Artful Expressions Exhibition", 5000000, "02 August 2023", R.drawable.slider_ticket1, R.drawable.ticket1, "10:00 PM", "Jakarta, Indonesia", "Experience the fleeting beauty of \"Ephemeral Dreams,\" an exquisite art exhibition that explores the transient nature of existence. Serenity Art Gallery invites you to immerse yourself in a world of delicate brushstrokes, fleeting emotions, and ephemeral visions captured by a collection of talented artists. Join us as we contemplate the impermanence of life through the lens of art."));
        arrayTicketOdd.add(new DataModel("Palette Perspectives Showcase", 5000000, "02 August 2023", R.drawable.slider_ticket3, R.drawable.ticket3, "10:00 PM", "Jakarta, Indonesia", "Discover the power of human creativity at \"Beyond Boundaries,\" an eclectic art event that pushes the limits of artistic expression. Gallery X proudly presents a diverse showcase of paintings, sculptures, and multimedia installations that transcend conventional boundaries. Delve into a realm where art knows no limits and imagination takes flight."));
        arrayTicketOdd.add(new DataModel("The Artistic Fusion Festival", 5000000, "02 August 2023",R.drawable.slider_ticket5, R.drawable.ticket5, "10:00 PM", "Jakarta, Indonesia", "Embark on an artistic journey through the heart of the city with \"Urban Rhythms.\" This dynamic event celebrates the vibrant street art scene, transforming public spaces into captivating galleries. Join the free walking tour to witness the colorful murals, graffiti, and urban art installations that breathe life into the urban landscape."));
        ...
        arrayTicketEven.add(new DataModel("Creative Canvas Symposium", 5000000, "02 August 2023", R.drawable.slider_ticket2, R.drawable.ticket2, "10:00 PM", "Jakarta, Indonesia", "Heritage Art Center presents \"Reflections of Identity,\" a thought-provoking art show that delves into the complexities of personal and cultural identity. Experience the emotive power of art as artists express their unique narratives and examine the ever-evolving tapestry of human identity."));
        arrayTicketEven.add(new DataModel("Enchanting Brushstrokes Fair", 5000000, "02 August 2023", R.drawable.slider_ticket4, R.drawable.ticket4, "10:00 PM", "Jakarta, Indonesia", "Step into the enchanting world of \"Whimsical Wonders,\" an art event hosted within the captivating Fairyland Gardens. Delight in a magical display of fairy tale-inspired illustrations, fanciful sculptures, and fantastical installations that transport visitors to a realm where imagination reigns supreme."));
        arrayTicketEven.add(new DataModel("Ephemeral Dreams", 5000000, "02 August 2023", R.drawable.ticket6,R.drawable.ticket6, "10:00 PM", "Jakarta, Indonesia", "Deskripsi Event"));
        arrayTicketEven.add(new DataModel("Urban Rhythms", 5000000, "02 August 2023", R.drawable.ticket8, R.drawable.ticket8,"10:00 PM", "Jakarta, Indonesia", "Deskripsi Event"));
        arrayTicketEven.add(new DataModel("Digital Realms", 5000000, "02 August 2023", R.drawable.ticket10, R.drawable.ticket10,"10:00 PM", "Jakarta, Indonesia", "Deskripsi Event"));
